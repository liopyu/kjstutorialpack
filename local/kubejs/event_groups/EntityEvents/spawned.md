...
- Event class: [EntitySpawnedEventJS](https://github.com/KubeJS-Mods/KubeJS/tree/2001/common/src/main/java/dev/latvian/mods/kubejs/entity/EntitySpawnedEventJS.java)
